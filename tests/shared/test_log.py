...
from app.shared.observability.log import (
    _console_formatter,
    _json_formatter,
    setup_logger,
)
...
class TestSetupLogger(unittest.TestCase):
    ...
    def test_setup_logger_configures_handlers_once(self) -> None:
        with TemporaryDirectory() as temp_dir:
            ...
            with (
                patch("app.shared.observability.log.LOG_DIR", log_dir),
                patch("app.shared.observability.log.logger.configure") as configure,
            ):
                setup_logger()
                setup_logger()
