...
from app.conf.app_config import LifecycleConfig
from app.models.conversation import ConversationInfo
from app.services.conversation_lifecycle_service import ConversationLifecycleService
...
class ConversationLifecycleServiceTest(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_expired_draft_deletes_all_conversation_resources(self) -> None:
        ...
        with (
            patch(
                "app.services.conversation_lifecycle_service.ConversationPGRepo",
                return_value=conversation_repo,
            ),
            patch(
                "app.services.conversation_lifecycle_service.SemanticRecallPGRepo",
