...
export const usePermissionStore = create<PermissionStore>()((set) => ({
	...
	clearFilter: () =>
		set({ filter: { userId: null, roleId: null, permissionId: null } }),
	...
	toggleUserSort: (field) =>
		set((state) => ({ userSort: toggleSort(state.userSort, field) })),
	roleSort: { field: "id", order: "asc" },
	toggleRoleSort: (field) =>
		set((state) => ({ roleSort: toggleSort(state.roleSort, field) })),
	...
	setEditUserRelationOpen: (editUserRelationOpen) =>
		set({ editUserRelationOpen }),
	...
	setOriginalRolePermissions: (originalRolePermissions) =>
		set({ originalRolePermissions }),
	editRoleRelationOpen: false,
	setEditRoleRelationOpen: (editRoleRelationOpen) =>
		set({ editRoleRelationOpen }),
	editRoleRelationTab: "users",
	setEditRoleRelationTab: (editRoleRelationTab) => set({ editRoleRelationTab }),

	// Permission dialog state
	createPermissionOpen: false,
	setCreatePermissionOpen: (createPermissionOpen) =>
		set({ createPermissionOpen }),
	createPermissionLoading: false,
	setCreatePermissionLoading: (createPermissionLoading) =>
		set({ createPermissionLoading }),
	editPermissionOpen: false,
	setEditPermissionOpen: (editPermissionOpen) => set({ editPermissionOpen }),
	editPermissionLoading: false,
	setEditPermissionLoading: (editPermissionLoading) =>
		set({ editPermissionLoading }),
	...
	setOriginalPermissionRoles: (originalPermissionRoles) =>
		set({ originalPermissionRoles }),
