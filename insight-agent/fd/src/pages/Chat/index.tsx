...
export default function ChatPage() {
  ...
  useEffect(() => {
    ...
    socket.onclose = (event) => {
      ...
      if (event.code === 4401) {
        redirectToAuthorize(`${window.location.pathname}${window.location.search}`);
        return;
      }
        ...
        <Card className="flex h-[calc(100vh-3rem)] flex-col overflow-hidden">
          <div className="flex items-center justify-between gap-4 p-6">
            <div>
              ...
              <h1 className="text-2xl font-semibold tracking-tight">Insight Agent</h1>
            ...
            {!routeConversationId ? (
              <div className="flex h-full items-center justify-center">
                <div className="max-w-xl text-center">
                  ...
                  <Button className="mt-6" onClick={() => void handleCreateConversation()}>
                    创建对话
                  </Button>
                </div>
              </div>
