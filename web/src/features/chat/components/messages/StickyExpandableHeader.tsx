...
export function StickyExpandableHeader({
  ...
  const getInnermostExpandedHeader = useCallback((): {
    ...
    const openItems = Array.from(
      viewport.querySelectorAll<HTMLElement>('[data-expandable-item][data-expandable-open="true"]')
    );
    ...
    for (const item of openItems) {
      const allHeaders = Array.from(item.querySelectorAll<HTMLElement>("[data-expandable-header]"));
