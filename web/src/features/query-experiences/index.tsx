...
import { ExperienceDetailDialog } from "@/features/query-experiences/ExperienceDetailDialog";
...
export function QueryExperienceManagement() {
  ...
  const disableExperiences = async (ids: string[]) => {
    ...
    setActingIds(ids);
    try {
      await queryExperiencesApi.disableQueryExperiences(ids);
  ...
  const deleteExperiences = async (ids: string[]) => {
    ...
    setActingIds(ids);
    try {
      await queryExperiencesApi.deleteQueryExperiences(ids);
      toast.success(
