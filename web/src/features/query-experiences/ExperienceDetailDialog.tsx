...
import {
  queryExperiencesApi,
  type QueryExperienceDetailResponse,
} from "@/features/query-experiences/api";
import { getApiErrorMessage } from "@/api/errors";
import { DotMatrixLoader } from "@/components/DotMatrixLoader";
import { AdminEditorDialog } from "@/components/AdminEditorDialog";
import { ExperienceSourceExecutionList } from "@/features/query-experiences/ExperienceSourceExecutionList";
...
export function ExperienceDetailDialog({ experienceId, onClose }: Props) {
  ...
  const load = useCallback(async () => {
    ...
    setError(null);
    try {
      setDetail(await queryExperiencesApi.getQueryExperience(experienceId));
    } catch (reason) {
